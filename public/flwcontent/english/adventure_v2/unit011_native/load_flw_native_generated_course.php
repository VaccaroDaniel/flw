...
$unitdir = 'D:/WinPro.Delta/Projects/FLW/FLW-V2/adventure-english-world/unit011';
$webcontentdir = $CFG->dirroot . '/flwcontent/english/adventure_v2/unit011_native';
$webcontenturl = $CFG->wwwroot . '/flwcontent/english/adventure_v2/unit011_native';
$shortname = 'FLW-AEW2-U011-NATIVE';
$fullname = 'Adventure English World V2 - Unit 11 Weather Window';
$coursesummary = '<p>FLW Moodle-native course generated from unit011.</p>';
$targetcategoryid = 0;
...
.flw-native .video-card .flw-video-shell{display:block;position:relative;width:100%;max-width:100%;height:auto;max-height:none;background:#000;border-radius:16px;overflow:hidden}
.flw-native .video-card .flw-video-shell video{position:static;display:block;width:100%;height:auto;aspect-ratio:16/9;max-height:none;border-radius:0;object-fit:contain}
...
function native_section_script(string $webcontenturl): string {
    $src = htmlspecialchars($webcontenturl . '/flw_native_test.js?v=' . time(), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8');
...
body.path-course-view #region-main .course-content {
...
.activity.label.modtype_label.flw-native-label .no-overflow,
.course-section:has(.flw-native) .no-overflow,
.course-section.flw-native-course-section .no-overflow {
    overflow:visible!important;
}
...
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .section-item,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .course-section-item,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .course-section-summary,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .section-summary-activities,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .activity,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .activity-item,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .activity-altcontent,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .activity-basis,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .description,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .contentwithoutlink,
body#page-course-view-topics.path-course-view .course-section.flw-native-course-section .no-overflow,
...
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .section-item,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .course-section-item,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .course-section-summary,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .section-summary-activities,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .activity,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .activity-item,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .activity-altcontent,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .activity-basis,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .description,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .contentwithoutlink,
body#page-course-view-topics.path-course-view .course-section:has(.flw-native) .no-overflow {
    background:transparent!important;
    border:0!important;
    box-shadow:none!important;
    outline:0!important;
...
.flw-native .hero .badge,
.flw-native .badges .badge {
...
.flw-native details.lesson.lesson-fold > summary::-webkit-details-marker,
.flw-native section.lesson > summary::-webkit-details-marker {
    display:none;
}
.flw-native details.lesson > summary::-webkit-details-marker {
    display:none;
}
.flw-native section.lesson,
.flw-native details.lesson,
.flw-native section.lesson .lesson-body,
.flw-native details.lesson .lesson-body {
    width:100%;
}
.flw-native details.lesson[open] > .can-do,
.flw-native section.lesson > .can-do {
    margin-top:18px!important;
}
.flw-native .image-card .zoom-btn,
.flw-native .img-card .zoom-btn,
.flw-native .imgbox .zoom-btn,
.flw-native .visual .zoom-btn,
.flw-native .img-plus {
    top:18px!important;
    right:18px!important;
}
.flw-native .flw-native-video,
.flw-native .video-card video,
.flw-native video.watch-video,
.flw-native .watch-video video,
.flw-native .watch-grid video,
.flw-native .watch-layout video {
...
.flw-native .video-card,
.flw-native .watch-video {
    min-width:0!important;
}
.flw-native .watch-grid,
.flw-native .watch-layout {
    grid-template-columns:minmax(460px,1.45fr) minmax(210px,.72fr) minmax(260px,.95fr)!important;
}
.flw-native .video-card {
    width:100%!important;
    padding:0!important;
    border:2px solid #d6ecff!important;
    background:#000!important;
    border-radius:16px!important;
    overflow:hidden!important;
...
.flw-native .video-card .flw-video-shell {
    display:block!important;
...
.flw-native .video-card .flw-video-shell video,
.flw-native .video-card .flw-video-shell .flw-native-video {
...
function normalize_native_video_tags(string $html): string {
    return preg_replace_callback('/<video\b([^>]*)>/i', function($matches) {
        $attrs = $matches[1];
        $attrs = preg_replace('/\swidth=(["\'])100%\1/i', '', $attrs);
        $attrs = preg_replace_callback('/\sclass=(["\'])(.*?)\1/i', function($classmatches) {
            $classes = preg_split('/\s+/', trim($classmatches[2]));
            if (!in_array('flw-native-video', $classes, true)) {
                $classes[] = 'flw-native-video';
            }
            return ' class="' . htmlspecialchars(trim(implode(' ', array_filter($classes))), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') . '"';
        }, $attrs, 1, $classcount);
        if ($classcount === 0) {
            $attrs .= ' class="flw-native-video"';
        }

        $nativevideo = 'display:block!important;width:100%!important;max-width:100%!important;min-height:0!important;aspect-ratio:16/9!important;height:auto!important;background:#000!important;object-fit:contain!important;box-sizing:border-box!important;border-radius:16px!important;overflow:hidden!important;';
        $attrs = preg_replace_callback('/\sstyle=(["\'])(.*?)\1/i', function($stylematches) use ($nativevideo) {
            $style = rtrim(trim($stylematches[2]), ';');
            if ($style !== '') {
                $style .= ';';
            }
            $style .= $nativevideo;
...
function rewrite_fragment_for_native(string $fragment, string $webcontenturl, string $rootid = '', string $unitdir = ''): string {
    ...
    $fragment = normalize_native_video_tags($fragment);
    if ($rootid === '' || $unitdir === '') {
        return '<div class="flw-native nolink">' . $fragment . '</div>';
    }
    $safeid = preg_replace('/[^A-Za-z0-9_-]/', '', $rootid);
    $css = native_section_css($safeid, $unitdir);
    return '<div id="' . htmlspecialchars($safeid, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') . '" class="flw-native nolink" data-flw-section-root="1"><style>' . PHP_EOL . $css . PHP_EOL . '</style>' . $fragment . native_section_script($webcontenturl) . '</div>';
}
...
function rewrite_teacher_guide_for_native(string $sourcefile, string $webcontenturl): string {
    ...
    $html = str_replace('url("assets/', 'url("' . $webcontenturl . '/assets/', $html);
    $html = str_replace("url('assets/", "url('" . $webcontenturl . "/assets/", $html);
    $html = normalize_native_video_tags($html);
    ...
    return '<div class="flw-native teacher-guide nolink">' . $html . '</div>';
}
...
$quizdata = add_quiz_activity($course, $quizsection, 'Unit 11 Weather Window', '');
