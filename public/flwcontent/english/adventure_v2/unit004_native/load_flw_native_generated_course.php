...
$unitdir = 'D:/WinPro.Delta/Projects/FLW/FLW-V2/adventure-english-world/unit004';
$webcontentdir = $CFG->dirroot . '/flwcontent/english/adventure_v2/unit004_native';
$webcontenturl = $CFG->wwwroot . '/flwcontent/english/adventure_v2/unit004_native';
$shortname = 'FLW-AEW2-U004-NATIVE';
$fullname = 'Adventure English World V2 - Unit 4 Classroom Magic';
$coursesummary = '<p>FLW Moodle-native course generated from unit004.</p>';
$targetcategoryid = 0;
...
function name_top_level_unit_block(string $fragment, int &$lessonnumber): string {
    ...
    if (fragment_has_class($fragment, 'lesson') || fragment_has_class($fragment, 'lesson-fold')) {
...
$quizdata = add_quiz_activity($course, $quizsection, 'Unit 4 Classroom Magic', '');
