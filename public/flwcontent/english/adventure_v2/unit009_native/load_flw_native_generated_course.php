...
$unitdir = 'D:/WinPro.Delta/Projects/FLW/FLW-V2/adventure-english-world/unit009';
$webcontentdir = $CFG->dirroot . '/flwcontent/english/adventure_v2/unit009_native';
$webcontenturl = $CFG->wwwroot . '/flwcontent/english/adventure_v2/unit009_native';
$shortname = 'FLW-AEW2-U009-NATIVE';
$fullname = 'Adventure English World V2 - Unit 9 Snack Time';
$coursesummary = '<p>FLW Moodle-native course generated from unit009.</p>';
$targetcategoryid = 0;
...
function top_level_unit_blocks(string $html): array {
    ...
    if (preg_match('/<main\b[^>]*>/i', $html, $mainmatch, PREG_OFFSET_CAPTURE)) {
        ...
        $offset = 0;
        while (preg_match('/<(header|section|details|article)\b[^>]*>/i', $prefix, $match, PREG_OFFSET_CAPTURE, $offset)) {
...
$quizdata = add_quiz_activity($course, $quizsection, 'Unit 9 Snack Time', '');
