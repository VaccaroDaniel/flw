...
- `flwcupkp_calsnapshot`: saved evidence calibration reports for threshold review over time.
- `flwcupkp_calproposal`: draft and activated threshold calibration proposals based on saved snapshots.
